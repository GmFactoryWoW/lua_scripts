...
CREATE TABLE IF NOT EXISTS `paragon_config_category` (
...
CREATE TABLE IF NOT EXISTS `paragon_config_statistic` (
    `id` INT NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_category`
        ...
        REFERENCES `paragon_config_category`(`id`)
            ON UPDATE CASCADE
            ON DELETE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS `paragon_config` (
