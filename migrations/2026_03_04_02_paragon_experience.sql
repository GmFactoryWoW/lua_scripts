...
CREATE TABLE IF NOT EXISTS `paragon_config_experience_creature` (
    `id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `paragon_config_experience_achievement` (
    `id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `paragon_config_experience_skill` (
    `id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `paragon_config_experience_quest` (
    `id` INT(11) NOT NULL,
